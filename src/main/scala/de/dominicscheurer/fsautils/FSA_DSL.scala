...
package de.dominicscheurer.fsautils {
  ...
  trait FSA_DSL {
    ...
    case class FSABuilder(t: (Symbol, Symbol, Symbol, Symbol, Symbol), isDFA: Boolean) {
      ...
      def where = (input: (Symbol, Any)) => input._2 match {
        case symbols: SymbolSet => input._1 match {
          case t._1 =>
            alphabet = Some(symbols.set); this
        }
        ...
        case stateSet: IntSet => input._1 match {
          ...
          case t._5 =>
            A = Some(stateSet.set.map(s => q(s))); this

        }
        case state: Int => input._1 match {
          case t._3 =>
            q0 = Some(q(state)); this
            ...
            def myDelta(s: State, l: Letter): State = s match {
              case q(i) =>
                if (func.fun contains ((i, l)))
                  ...
                  throw new Exception("DFA transition function must be total, "
